...
const CATEGORIES: { key: string; label: string; logos: Logo[] }[] = [
  {
    ...
    logos: [
      { name: "Avaya", url: avayaLogo, href: "https://www.avaya.com/en/" },
      { name: "Cisco", url: ciscoLogo, href: "https://www.cisco.com/" },
      { name: "Hikvision", url: hikvisionLogo, href: "https://www.hikvision.com/sa/" },
      { name: "Nexen Strategy", url: nexenLogo, href: "https://nexenstrategy.com/" },
      { name: "DLI Saudi", url: prestigeLogo, href: "https://www.dlisaudi.com/" },
    ],
  },
  {
    key: "software",
    ...
    logos: [
      { name: "Entry2Exit", url: entry2exitLogo, href: "https://entry2exit.com/" },
      { name: "Fadelsoft", url: fadelLogo, href: "https://fadelsoft.com/" },
      { name: "Odoo", url: odooLogo, href: "https://www.odoo.com/" },
      { name: "Sapaad", url: sapaadLogo, href: "https://www.sapaad.com/" },
    ],
  },
  {
    key: "ai-video",
    ...
    logos: [
      { name: "Coram AI", url: coramLogo, href: "https://www.coram.ai/" },
      { name: "TRASSIR", url: trassirLogo, href: "https://trassir.com/" },
      { name: "Vizo361 AI", url: vizo361Logo, href: "https://vizo361.ai/" },
    ],
  },
  {
    key: "smart-screens",
    ...
    logos: [
      { name: "Windro", url: windroLogo, href: "https://windro.cn/" },
      { name: "ZhSunyco", url: zhsunycoLogo, href: "https://www.zhsunyco.com/" },
    ],
  },
];
