...
import razaImg from "@/assets/team/Saudagar_Raza_CEO.png";
import anasImg from "@/assets/team/Anas_COO.jpeg";
import maqboolImg from "@/assets/team/Maqbool_Pasha_CFO.png";
import naveedImg from "@/assets/team/Soudagar_Naveed_Procurement_Sales1.png";
import suhailImg from "@/assets/team/Suhail_Team_Leader.png";
import shuaibImg from "@/assets/team/Shoaib_Tech_Support_Remote.png";
import imranImg from "@/assets/team/Imran_Tech_Support_Remote.png";
import furkhanImg from "@/assets/team/Furkhan_Tech_Support.png";
import faizanImg from "@/assets/team/Faizan_Khazi_Tech_Support.png";
import mohsinImg from "@/assets/team/Mohsin_Sr_Tech_Support.png";
import zafarImg from "@/assets/team/Khazi_Zafar_Chief_Strategic_Planning.jpeg";
import zeeshanImg from "@/assets/team/Zeeshan_Tech_Support_Remote.png";
  ...
  head: () => ({
    meta: [
      { title: "Team — Roya Ventures" },
      {
        name: "description",
        content:
          "Meet the leadership, strategy, operations and technical team behind Roya Ventures.",
      },
      { property: "og:title", content: "Team — Roya Ventures" },
      {
        property: "og:description",
        content: "A senior team built around partnership and discretion.",
      },
    ],
  }),
  component: TeamPage,
...
const STRATEGY_ADMIN: Member[] = [
  {
    img: zafarImg,
    name: "Khazi Zafar",
    role: "Chief Strategic & Planning",
    bio: "Leads strategic planning and business direction — aligning long-term objectives with operational execution across the group.",
  },
  {
    img: "",
    name: "Sameena Khazi",
    role: "HR & Admin",
    bio: "Oversees people, culture and administrative operations — ensuring the firm runs with care, clarity and operational discipline.",
  },
];
...
const OPERATIONS_FINANCE: Member[] = [
  {
    ...
    bio: "Directs delivery across the project portfolio — accountable for scope, schedule and quality on every engagement.",
  },
  {
    img: maqboolImg,
    name: "Maqbool Pasha",
    role: "Chief Accountant",
    bio: "Oversees financial controls, reporting and accounting — safeguarding the firm's fiscal integrity and operational transparency.",
  },
];
...
const PROCUREMENT_TECHNICAL: Member[] = [
  {
    img: naveedImg,
    name: "Saudagar Naveed",
    role: "Procurement & Sales",
    bio: "Bridges procurement, sales and client development — bringing technical depth to new opportunities and mandates.",
  },
  {
    img: suhailImg,
    name: "Suhail Shaik",
    role: "Technical Lead",
    bio: "Leads the technical team on the ground — coordinating design, deployment and commissioning across projects.",
  },
];
...
const TECHNICAL_SUPPORT: Member[] = [
  {
    img: shuaibImg,
    name: "Mohammed Shoeb",
    role: "Tech Support Remote",
    bio: "Provides remote technical support — resolving issues with precision and maintaining client uptime.",
  },
  {
    img: imranImg,
    name: "Syed Abdul Razzak Imran",
    role: "Tech Support Remote",
    bio: "Delivers remote technical assistance — ensuring systems stay operational and clients receive timely support.",
  },
  {
    img: zeeshanImg,
    name: "Zeeshan Islam",
    role: "Tech Support Remote",
    bio: "Supports clients and systems remotely — combining technical skill with responsive, clear communication.",
  },
  {
    img: furkhanImg,
    name: "Khazi Furkhan",
    role: "Tech Support",
    bio: "Executes on-site technical support with a focus on quality workmanship and reliable, standards-based delivery.",
  },
  {
    img: faizanImg,
    name: "Khazi Faizan",
    role: "Tech Support",
    bio: "Delivers hands-on technical support across IT and ELV systems — from installation through configuration and handover.",
  },
  {
    img: mohsinImg,
    name: "Mohsin Mohammed",
    role: "Sr. Tech Support",
    bio: "Leads the technical support function — mentoring the team and ensuring complex issues are resolved efficiently.",
  },
];
  ...
  return (
    <SiteLayout transparentHeader>
      <PageHero
        ...
        title={
          <>
            Senior counsel from <span className="text-[var(--gold)]">operators</span> who have led.
          </>
        }
      ...
      <section className="relative section-y overflow-hidden">
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            ...
            title={
              <>
                The <em className="not-italic text-[var(--gold)]">vision</em> that leads the firm.
              </>
            }
      ...
      <section className="relative section-y overflow-hidden bg-[var(--ivory)]">
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            ...
            title={
              <>
                Stewards of <em className="not-italic text-[var(--gold)]">direction</em> and
                culture.
              </>
            }
      ...
      <section className="relative section-y overflow-hidden">
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            ...
            title={
              <>
                The discipline that <em className="not-italic text-[var(--gold)]">delivers</em>{" "}
                every mandate.
              </>
            }
      ...
      <section className="relative section-y overflow-hidden bg-[var(--ivory)]">
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            ...
            title={
              <>
                The bridge between <em className="not-italic text-[var(--gold)]">opportunity</em>{" "}
                and execution.
              </>
            }
      ...
      <section className="relative section-y overflow-hidden">
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            ...
            title={
              <>
                The engineers behind the <em className="not-italic text-[var(--gold)]">craft.</em>
              </>
            }
...
function MemberCard({ member: p }: { member: Member }) {
  return (
    <article className="group relative h-full rounded-[20px] bg-gradient-to-b from-white to-[color-mix(in_oklab,var(--stone)_55%,white)] border border-[color-mix(in_oklab,var(--navy)_10%,transparent)] shadow-[0_1px_0_rgba(255,255,255,0.8)_inset,0_1px_2px_rgba(24,49,78,0.04),0_8px_24px_-16px_rgba(24,49,78,0.18)] transition-all duration-[700ms] ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:shadow-[0_1px_0_rgba(255,255,255,0.9)_inset,0_2px_6px_rgba(24,49,78,0.06),0_18px_44px_-24px_rgba(24,49,78,0.28)] hover:-translate-y-1.5 hover:border-[color-mix(in_oklab,var(--gold)_45%,transparent)]">
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-[var(--gold)]/70 to-transparent"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute top-2.5 left-2.5 h-3.5 w-3.5 border-l border-t border-[var(--gold)]/70 rounded-tl-[6px]"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute top-2.5 right-2.5 h-3.5 w-3.5 border-r border-t border-[var(--gold)]/70 rounded-tr-[6px]"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute bottom-2.5 left-2.5 h-3.5 w-3.5 border-l border-b border-[var(--gold)]/70 rounded-bl-[6px]"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute bottom-2.5 right-2.5 h-3.5 w-3.5 border-r border-b border-[var(--gold)]/70 rounded-br-[6px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -top-16 -right-16 h-48 w-48 rounded-full bg-[radial-gradient(circle,color-mix(in_oklab,var(--gold)_18%,transparent),transparent_65%)] blur-2xl"
      />
      ...
      <div className="grid gap-0 sm:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
        ...
        <div className="p-4 sm:p-5">
          <div className="relative overflow-hidden rounded-[14px] max-w-[9rem] mx-auto sm:max-w-none aspect-[4/5] bg-gradient-to-b from-[var(--navy)] to-[var(--navy-deep)] ring-1 ring-[color-mix(in_oklab,var(--navy)_12%,transparent)] shadow-[0_12px_28px_-16px_rgba(24,49,78,0.45)]">
            <div
              aria-hidden
              className="absolute inset-0 bg-[radial-gradient(circle_at_top,color-mix(in_oklab,var(--gold)_20%,transparent),transparent_65%)]"
            />
            {p.img ? (
              <img
                src={p.img}
...
function FeaturedCard({ member: p }: { member: Member }) {
  return (
    <article className="group relative overflow-hidden rounded-[22px] bg-gradient-to-b from-white to-[color-mix(in_oklab,var(--stone)_55%,white)] border border-[color-mix(in_oklab,var(--navy)_10%,transparent)] shadow-[0_1px_0_rgba(255,255,255,0.8)_inset,0_2px_6px_rgba(24,49,78,0.06),0_30px_70px_-24px_rgba(24,49,78,0.28)] transition-all duration-[700ms] ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:shadow-[0_1px_0_rgba(255,255,255,0.9)_inset,0_4px_10px_rgba(24,49,78,0.08),0_44px_90px_-30px_rgba(24,49,78,0.4)] hover:-translate-y-1.5 hover:border-[color-mix(in_oklab,var(--gold)_45%,transparent)]">
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-[var(--gold)]/70 to-transparent"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute top-3 left-3 h-4 w-4 border-l border-t border-[var(--gold)]/70 rounded-tl-[8px]"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute top-3 right-3 h-4 w-4 border-r border-t border-[var(--gold)]/70 rounded-tr-[8px]"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute bottom-3 left-3 h-4 w-4 border-l border-b border-[var(--gold)]/70 rounded-bl-[8px]"
      />
      <span
        aria-hidden
        className="pointer-events-none absolute bottom-3 right-3 h-4 w-4 border-r border-b border-[var(--gold)]/70 rounded-br-[8px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -top-24 -right-24 h-72 w-72 rounded-full bg-[radial-gradient(circle,color-mix(in_oklab,var(--gold)_22%,transparent),transparent_65%)] blur-2xl"
      />
      ...
      <div className="grid gap-0 md:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
        ...
        <div className="p-4 md:p-5">
          <div className="relative overflow-hidden rounded-[16px] max-w-[12rem] mx-auto md:max-w-none aspect-[4/5] bg-gradient-to-b from-[var(--navy)] to-[var(--navy-deep)] ring-1 ring-[color-mix(in_oklab,var(--navy)_12%,transparent)] shadow-[0_16px_32px_-18px_rgba(24,49,78,0.45)]">
            <div
              aria-hidden
              className="absolute inset-0 bg-[radial-gradient(circle_at_top,color-mix(in_oklab,var(--gold)_22%,transparent),transparent_65%)]"
            />
            {p.img ? (
              <img
                src={p.img}
